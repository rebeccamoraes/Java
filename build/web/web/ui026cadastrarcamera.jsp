...
<html lang="pt-br">
    <head>
        <title>Cadastrar Câmera| DigiMon</title>
                    ...
                    <form action="#" method="post" id="formularioJ">
                        <fieldset>
                            ...
                            <div class="campo"> 
                                ...
                                <input type="text" name="fabricante" class="campoObrig iLetras"  maxlength="20" id="fabricanteJ" size="32" ><span id="x_fabricanteJ" class="tSpan"></span>
                            </div>
                            <div class="campo"> 
                                <label for="modeloJ">Modelo:</label> <br>
                                <input type="text" name="modelo" class="campoObrig" maxlength="20" id="modeloJ" size="30" ><span id="x_modeloJ" class="tSpan"></span>
                            </div>
                            <div class="campo"> 
                                <label for="numserieJ">Número de Série:</label> <br>
                                <input type="text" name="numserie" class="campoObrig" maxlength="15" id="numserieJ" size="16" ><span id="x_numserieJ" class="tSpan"></span>
                            </div>
                            <div class="campo"> 
                        ...
                        <fieldset>
                            ...
                            <div class="campo"> 
                                <label for="ufIncialJ">UF:</label> <br>						
